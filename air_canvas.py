...
cv2.createTrackbar("Upper Hue", "Color detectors", 180, 180,setValues)
cv2.createTrackbar("Upper Saturation", "Color detectors", 255, 255,setValues)
cv2.createTrackbar("Upper Value", "Color detectors", 255, 255,setValues)
cv2.createTrackbar("Lower Hue", "Color detectors", 142, 180,setValues)
cv2.createTrackbar("Lower Saturation", "Color detectors", 111, 255,setValues)
cv2.createTrackbar("Lower Value", "Color detectors", 137, 255,setValues)
# In[4]:
